...
import com.avans.encoder.Frame;
import com.avans.encoder.audio.AudioEncoder;
import com.avans.encoder.audio.GetAacData;
import com.avans.encoder.input.audio.CustomAudioEffect;
import com.avans.encoder.input.audio.GetMicrophoneData;
import com.avans.encoder.input.audio.MicrophoneManager;
import com.avans.encoder.input.audio.MicrophoneManagerManual;
import com.avans.encoder.input.audio.MicrophoneMode;
import com.avans.encoder.input.video.Camera1ApiManager;
import com.avans.encoder.input.video.CameraCallbacks;
import com.avans.encoder.input.video.CameraHelper;
import com.avans.encoder.input.video.CameraOpenException;
import com.avans.encoder.input.video.GetCameraData;
import com.avans.encoder.utils.CodecUtil;
import com.avans.encoder.video.FormatVideoEncoder;
import com.avans.encoder.video.GetVideoData;
import com.avans.encoder.video.VideoEncoder;
import com.avans.rtplibrary.util.FpsListener;
import com.avans.rtplibrary.util.RecordController;
import com.avans.rtplibrary.view.GlInterface;
import com.avans.rtplibrary.view.LightOpenGlView;
import com.avans.rtplibrary.view.OffScreenGlThread;
import com.avans.rtplibrary.view.OpenGlView;
...
public abstract class Camera1Base
   ...
   *
   * @param cameraFacing front or back camera. Like: {@link com.avans.encoder.input.video.CameraHelper.Facing#BACK}
   * {@link com.avans.encoder.input.video.CameraHelper.Facing#FRONT}
   * @param width of preview in px.
   * @param height of preview in px.
   * @param rotation camera rotation (0, 90, 180, 270). Recommended: {@link
   * com.avans.encoder.input.video.CameraHelper#getCameraOrientation(Context)}
   */
